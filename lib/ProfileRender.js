...
function initProfileRenderCore (context) {
  ...
  var ProfileRender = context.ProfileRender = function (opt_config) {
    ...
    this.Stack = [
      { part_name: "OriginCrosshair", offset: [0, 0, 0], entities: [
        { type: "line", origin: [0, 0, 0], end: [this._crosshair_size, 0, 0], color: this._colorRed },
        { type: "line", origin: [0, 0, 0], end: [-this._crosshair_size, 0, 0], color: this._colorRed },
        { type: "line", origin: [0, 0, 0], end: [0, this._crosshair_size, 0], color: this._colorRed },
        { type: "line", origin: [0, 0, 0], end: [0, -this._crosshair_size, 0], color: this._colorRed },
        { type: "line", origin: [0, 0, 0], end: [0, 0, this._crosshair_size], color: this._colorRed },
        { type: "line", origin: [0, 0, 0], end: [0, 0, -this._crosshair_size], color: this._colorRed },
      ], meta_data: {}, updateRender: true},
    ];
    ...
    for (var x = 0; x < this.Stack.length; x++)
    {
      ...
      if (part.updateRender == true)
      {
        ...
        for (var y = 0; y < part.entities.length; y++)
        {
          ...
          if (entity.type == "line")
          {
            this.drawLine(part, entity);
          }
          if (entity.type == "arc")
          {
            this.drawArc(part, entity);
          }
        }
      }
    }
  ...
  ProfileRender.prototype.init = function () {
    ...
    this.controls.mouseButtons = { ORBIT: THREE.MOUSE.MIDDLE };
  ...
  ProfileRender.prototype.drawLine = function (part, line) {
    var material = new THREE.LineBasicMaterial( { color: line.color } );
  ...
  ProfileRender.prototype.drawArc = function (part, arc) {
    ...
    var material = new THREE.LineBasicMaterial( { color : arc.color } );
    var line = new THREE.Line( geometry, material );
    line.part_name = part.part_name; //Store the part name in the scene object
    this.scene.add( line );
    return line;
  ...
  ProfileRender.prototype.scale_originCrosshair = function (scale){
    for (var x = 0; x < this.Stack.length; x++)
    {
      if (this.Stack[x].part_name == "OriginCrosshair")
      {
        ...
        { type: "line", origin: [0, 0, 0], end: [(scale * this._crosshair_size), 0, 0], color: this._colorRed },
        { type: "line", origin: [0, 0, 0], end: [-(scale * this._crosshair_size), 0, 0], color: this._colorRed },
        { type: "line", origin: [0, 0, 0], end: [0, (scale * this._crosshair_size), 0], color: this._colorRed },
        { type: "line", origin: [0, 0, 0], end: [0, -(scale * this._crosshair_size), 0], color: this._colorRed },
        { type: "line", origin: [0, 0, 0], end: [0, 0, (scale * this._crosshair_size)], color: this._colorRed },
        { type: "line", origin: [0, 0, 0], end: [0, 0, -(scale * this._crosshair_size)], color: this._colorRed },
        ];
